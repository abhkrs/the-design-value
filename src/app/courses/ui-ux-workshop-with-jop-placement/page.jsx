      ...
      <main>
          ...
          <div className="lg:w-1/3 z-40 relative lg:-top-10 z-50 hidden lg:block">
            ...
            >
              <H3 className="!font-semibold !text-xl">
                ...
                <button className="bg-[red]" onClick={handleSubscribe}>
                  Buy Now
                </button>
              </H3>
          ...
          <div className="lg:w-2/3 grid gap-8 lg:pr-8">
            <div className="bg-white px-12 py-10 rounded shadow ">
              ...
              <P className="text-gray-600 mt-4 !text-base">
                This is a complete UI/UX design course where you will be
                learning the principals of design and the tools of UI design
                from beginner to masterclass level. After the 5 months duration
                of this course,{" "}
            ...
            <div className="bg-white px-12 py-10 rounded shadow">
              ...
              <div className="grid grid-cols-2 gap-6 mt-4 text-gray-600">
                <div>
                  <P>
                    <span className="mr-2 font-bold">&#x2713; </span>User
                    Persona
                  </P>
                  <P>
                ...
                <div>
                  ...
                  <P>
                    <span className="mr-2 font-bold">&#x2713; </span>UI Brand
                    Kit
                  </P>
                  <P>
            ...
            <div className="bg-white px-12 py-10 rounded shadow">
              ...
              <AccordionTab heading="Foundations of UI/UX Design">
                <ul className="!list-disc ml-4">
                  ...
                  <li>
                    Exploring the relationship between design and user
                    experience, and how they impact user satisfaction and
                    engagement.
                  </li>
                  <li>
                    Familiarizing yourself with the design process and the
                    various stages involved in creating user-centered designs.
                  </li>
                </ul>
              </AccordionTab>
              <AccordionTab heading="User Research and Analysis">
                <ul className="ml-4 list-disc">
                  <li>
                    Learning how to conduct user research using techniques such
                    as interviews, surveys, and observation.
                  </li>
                  <li>
                    Understanding how to gather and analyze data to identify
              ...
              <AccordionTab heading="User Interface Design">
                <ul className="ml-4 list-disc">
                  ...
                  <li>
                    Understanding color theory and how to choose appropriate
                    color schemes for different purposes.
                  </li>
                  <li>
                    Creating wireframes, which are basic skeletal
                    representations of a user interface, to plan and structure
                    your designs.
                  </li>
                  <li>
                    Translating wireframes into high-fidelity mockups using
                    design software like Adobe XD, Sketch, or Figma.
                  </li>
                </ul>
              </AccordionTab>
              <AccordionTab heading="Visual Design and Branding">
                <ul className="ml-4 list-disc">
                  <li>
                    Understanding the role of visual design in creating
                    appealing and cohesive user interfaces.
                  </li>
                  <li>
                    Learning how to create a visual identity and style guide for
                    a digital product.
                  </li>
                  <li>
              ...
              <AccordionTab heading="Tools and Software">
                <ol className="ml-4 list-decimal">
                  ...
                  <ul className="ml-4 list-disc">
                    <li>
                      Overview of Figma as a powerful design and prototyping
                      tool.
                    </li>
                    <li>
                  ...
                  <ul className="ml-4 list-disc">
                    ...
                    <li>
                      Defining transitions and animations to bring your designs
                      to life.
                    </li>
                    <li>
                  ...
                  <ul className="ml-4 list-disc">
                    ...
                    <li>
                      Managing version control to track design changes and
                      revert if necessary.
                    </li>
                  </ul>
                  ...
                  <ul className="ml-4 list-disc">
                    ...
                    <li>
                      Exploring advanced techniques like vector editing,
                      masking, and advanced prototyping.
                    </li>
                    <li>
                      Optimizing workflow with keyboard shortcuts and
                      productivity hacks.
                    </li>
                    <li>
                      Exploring design handoff and export options for
                      developers.
                    </li>
                  </ul>
        ...
        <div className="fixed bottom-0 bg-white rounded-t-xl p-4 lg:hidden w-full">
          <div className="mx-auto text-center">
            <span className="p-2 bg-[#CE4863] mr-2 !text-sm">
              😲 Flat 58% Off
            </span>
