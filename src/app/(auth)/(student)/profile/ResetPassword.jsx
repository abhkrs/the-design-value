...
function ResetPassword() {
  ...
  return (
    <div className="flex justify-between align-middle flex-col gap-8">
      <input
        name="new-user-id"
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-2/4 -translate-y-2/4 right-8 md:right-4 text-red-500"
        >
      ...
      <div className="relative">
        ...
        <button
          type="button"
          onClick={toggleRePasswordVisibility} // Toggle password visibility on button click
          className="absolute top-2/4 -translate-y-2/4 right-8 md:right-4 text-red-500"
        >
