        ...
        <SectionDark className="py-16 !text-white text-center">
            ...
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 mt-12 mb-8 capitalize gap-6 !text-white">
                <div className="sm:border-r lg:pr-6 pr-auto">
                    ...
                    <P className="!text-white !text-xl">Students Enrolled so far</P>
                    <hr className="w-2/3 sm:hidden mx-auto mt-8" />
                </div>
                <div className="lg:border-r lg:pr-6 pr-auto">
                    <H3 className="!text-6xl mb-4">30</H3>
                    <P className="!text-white !text-xl">Mentors with IT experience</P>
                    <hr className="w-2/3 sm:hidden mx-auto mt-8" />
                </div>
                <div className="sm:border-r lg:pr-6 pr-auto">
                    <H3 className="!text-6xl mb-4">300</H3>
                    <P className="!text-white !text-xl">Jobs Provided</P>
                    <hr className="w-2/3 sm:hidden mx-auto mt-8" />
                </div>
                <div className=" lg:pr-6 pr-auto">
                    <H3 className="!text-6xl mb-4">50</H3>
                    <P className="!text-white !text-xl">Internship Provided</P>
                </div>
            </div>
        </SectionDark>
    );
